      ...
      <div className="container mx-auto px-6 relative">
        ...
        >
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="flex items-start">
                ...
                <label htmlFor="consent" className="ml-3 text-sm text-gray-300">
                  J'accepte de recevoir des informations sur PlexView et je
                  comprends que mes données seront traitées conformément à la{" "}
          ...
          <div className="mt-8 text-center text-sm text-gray-400">
            <p>
              Les places sont limitées. Nous vous contacterons dès qu'une place
              sera disponible.
            </p>
          </div>
        </div>
